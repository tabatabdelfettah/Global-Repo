...
import com.globale.book.error.RecoredNotFoundExecption;
...
public class BaseService<T extends BaseEntity<ID>, ID extends Number>  {
	...
	@Autowired
	private MessageSource  messageUtils;
	...
	public T findById(ID id) {
		...
		if (entity.isPresent()) {
			...
			String msg = messageUtils.getMessage("validation.recoredNotFound.message", msgParam,LocaleContextHolder.getLocale());
